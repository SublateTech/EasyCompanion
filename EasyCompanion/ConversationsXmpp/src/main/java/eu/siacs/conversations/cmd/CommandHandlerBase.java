...
import eu.siacs.conversations.SettingsManager;
...
public abstract class CommandHandlerBase {
    ...
    static XmppConnectionService sMainService = null;
    ...
    CommandHandlerBase(XmppConnectionService mainService, int cmdType, String name, Cmd... commands) {
    ...
    public final void activate() {
        mIsActivated = true;
        Log.i(LOGTAG, "Activating command " + mName);
        onCommandActivated();
    }
    ...
    public final void deactivate() {
        mIsActivated = false;
        Log.i(LOGTAG,"Deactivating command " + mName);
    ...
    void executeNewCmd(String cmd, String args) {
        Intent i = new Intent(XmppConnectionService.ACTION_COMMAND);
        i.putExtra("cmd", cmd);
        if (args != null) {
    ...
    ArrayList<String> help() {
        ...
        for (Cmd c : mCommandMap.values()) {
            ...
            for (Cmd.SubCmd sc : c.getSubCmds()) {
                if (sc.getHelp() != null) {
                    res.add(sc.getHelp());
                }
            }
    ...
    String makeBold(String msg) {
        return msg; //XmppMsg.makeBold(msg);
    }
