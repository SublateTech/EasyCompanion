...
public final class Config {
	...
	*/
	...
	public static final String LOGTAG = "xmmpClient";

	public static final String BUG_REPORTS = "bugs@sublate.net";
	...
	public static final String MAGIC_CREATE_DOMAIN = "sublate.net";
