...
import com.sublate.xmppsensor.crypto.XmppDomainVerifier;
import com.sublate.xmppsensor.crypto.sasl.Anonymous;
import com.sublate.xmppsensor.crypto.sasl.DigestMd5;
import com.sublate.xmppsensor.crypto.sasl.External;
import com.sublate.xmppsensor.crypto.sasl.Plain;
import com.sublate.xmppsensor.crypto.sasl.SaslMechanism;
import com.sublate.xmppsensor.crypto.sasl.ScramSha1;
...
import com.sublate.xmppsensor.utils.DNSHelper;
import com.sublate.xmppsensor.utils.SSLSocketHelper;
import com.sublate.xmppsensor.utils.SocksSocketFactory;
import com.sublate.xmppsensor.utils.Xmlns;
import com.sublate.xmppsensor.xml.Element;
import com.sublate.xmppsensor.xml.Tag;
import com.sublate.xmppsensor.xml.TagWriter;
import com.sublate.xmppsensor.xml.XmlReader;
import com.sublate.xmppsensor.xmpp.forms.Data;
import com.sublate.xmppsensor.xmpp.forms.Field;
import com.sublate.xmppsensor.xmpp.jid.InvalidJidException;
import com.sublate.xmppsensor.xmpp.jid.Jid;
import com.sublate.xmppsensor.xmpp.stanzas.AbstractAcknowledgeableStanza;
...
import com.sublate.xmppsensor.xmpp.stanzas.csi.ActivePacket;
import com.sublate.xmppsensor.xmpp.stanzas.csi.InactivePacket;
import com.sublate.xmppsensor.xmpp.stanzas.streammgmt.AckPacket;
import com.sublate.xmppsensor.xmpp.stanzas.streammgmt.EnablePacket;
import com.sublate.xmppsensor.xmpp.stanzas.streammgmt.RequestPacket;
import com.sublate.xmppsensor.xmpp.stanzas.streammgmt.ResumePacket;
...
public class XmppConnection implements Runnable {
	...
	private void processPresence(final Tag currentTag) throws XmlPullParserException, IOException {
		...
		if (Config.DEBUG)
			Log.d(TAG, "Recv Presence:" + packet);
	}
	...
	public String sendIqPacket(Contact contact, final IqPacket packet, final OnIqPacketReceived callback) {
	...
	private synchronized void sendPacket(final AbstractStanza packet) {
		...
		synchronized (this.mStanzaQueue) {
			...
			if (Config.DEBUG)
				Log.d(TAG, "Sent:" + packet.toString());
		}
	}
