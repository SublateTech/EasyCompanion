...
public class EnterJidDialog {
	...
	public EnterJidDialog(
		...
		View dialogView = LayoutInflater.from(context).inflate(eu.siacs.conversations.app.R.layout.enter_jid_dialog, null);
		final TextView jabberIdDesc = (TextView) dialogView.findViewById(eu.siacs.conversations.app.R.id.jabber_id);
		jabberIdDesc.setText(eu.siacs.conversations.app.R.string.account_settings_jabber_id);
		...
		jid.setAdapter(new KnownHostsAdapter(context, eu.siacs.conversations.app.R.layout.simple_list_item, knownHosts));
		...
		jid.setHint(eu.siacs.conversations.app.R.string.account_settings_example_jabber_id);
		...
		this.dialogOnClick = new View.OnClickListener() {
			...
			public void onClick(final View v) {
				...
				try {
					...
					jid.setError(context.getString(eu.siacs.conversations.app.R.string.invalid_jid));
					return;
				}
