...
public class ChooseContactActivity extends AbstractSearchableListItemActivity {
		...
		if (getIntent().getBooleanExtra("multiple", false)) {
			...
			getListView().setMultiChoiceModeListener(new MultiChoiceModeListener() {
				...
				public boolean onCreateActionMode(ActionMode mode, Menu menu) {
					...
					inflater.inflate(eu.siacs.conversations.app.R.menu.select_multiple, menu);
				...
				public boolean onActionItemClicked(ActionMode mode, MenuItem item) {
					switch(item.getItemId()) {
						case eu.siacs.conversations.app.R.id.selection_submit:
				...
				public void onItemCheckedStateChanged(ActionMode mode, int position, long id, boolean checked) {
					...
					MenuItem selectButton = mode.getMenu().findItem(eu.siacs.conversations.app.R.id.selection_submit);
					String buttonText = getResources().getQuantityString(eu.siacs.conversations.R.plurals.select_contact,
	...
	public void onStart() {
		...
		@StringRes
		int res = intent != null ? intent.getIntExtra(EXTRA_TITLE_RES_ID, eu.siacs.conversations.R.string.title_activity_choose_contact) : eu.siacs.conversations.R.string.title_activity_choose_contact;
		ActionBar bar = getActionBar();
		if (bar != null) {
			try {
				bar.setTitle(res);
			} catch (Exception e) {
				bar.setTitle(eu.siacs.conversations.R.string.title_activity_choose_contact);
			}
		}
	}
	...
	public boolean onCreateOptionsMenu(final Menu menu) {
		...
		menu.findItem(eu.siacs.conversations.app.R.id.action_create_contact).setVisible(showEnterJid);
		return true;
	}
	...
	protected void showEnterJidDialog() {
		EnterJidDialog dialog = new EnterJidDialog(
			...
			getString(eu.siacs.conversations.R.string.enter_contact), getString(eu.siacs.conversations.R.string.select),
