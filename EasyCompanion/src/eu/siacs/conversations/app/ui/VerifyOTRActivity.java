...
public class VerifyOTRActivity extends XmppActivity implements XmppConnectionService.OnConversationUpdate {
	...
	private DialogInterface.OnClickListener mVerifyFingerprintListener = new DialogInterface.OnClickListener() {
		...
		public void onClick(DialogInterface dialogInterface, int click) {
			...
			Toast.makeText(VerifyOTRActivity.this, eu.siacs.conversations.app.R.string.verified, Toast.LENGTH_SHORT).show();
			finish();
		}
	};
		...
		public void onClick(final View view) {
			if (isAccountOnline()) {
				...
				if (question.trim().isEmpty()) {
					...
					mSharedSecretHintEditable.setError(getString(eu.siacs.conversations.app.R.string.shared_secret_hint_should_not_be_empty));
				} else if (secret.trim().isEmpty()) {
					mSharedSecretSecret.requestFocus();
					mSharedSecretSecret.setError(getString(eu.siacs.conversations.app.R.string.shared_secret_can_not_be_empty));
				} else {
	...
	protected boolean verifyWithUri(XmppUri uri) {
		...
		if (this.mConversation.getContact().getJid().equals(uri.getJid()) && uri.hasFingerprints()) {
			...
			Toast.makeText(this, eu.siacs.conversations.app.R.string.verified, Toast.LENGTH_SHORT).show();
			updateView();
			return true;
		} else {
			Toast.makeText(this, eu.siacs.conversations.app.R.string.could_not_verify_fingerprint, Toast.LENGTH_SHORT).show();
			return false;
		}
	}
	...
	protected void updateView() {
		if (this.mConversation != null && this.mConversation.hasValidOtrSession()) {
			...
			this.mVerificationExplain.setText(eu.siacs.conversations.app.R.string.no_otr_session_found);
			invalidateOptionsMenu();
			switch(this.mode) {
				case MODE_ASK_QUESTION:
					if (actionBar != null ) {
						actionBar.setTitle(eu.siacs.conversations.app.R.string.ask_question);
					}
					this.updateViewAskQuestion();
					break;
				case MODE_ANSWER_QUESTION:
					if (actionBar != null ) {
						actionBar.setTitle(eu.siacs.conversations.app.R.string.smp_requested);
					}
				...
				default:
					if (actionBar != null ) {
						actionBar.setTitle(eu.siacs.conversations.app.R.string.manually_verify);
					}
	...
	protected void updateViewManualVerification() {
		this.mVerificationExplain.setText(eu.siacs.conversations.app.R.string.manual_verification_explanation);
		...
		if (this.mConversation.isOtrFingerprintVerified()) {
			deactivateButton(this.mRightButton, eu.siacs.conversations.app.R.string.verified);
			activateButton(this.mLeftButton, eu.siacs.conversations.app.R.string.cancel,this.mFinishListener);
		} else {
			activateButton(this.mLeftButton, eu.siacs.conversations.app.R.string.cancel,this.mFinishListener);
			activateButton(this.mRightButton, eu.siacs.conversations.app.R.string.verify, new View.OnClickListener() {
				@Override
				public void onClick(View view) {
	...
	protected void updateViewAskQuestion() {
		...
		this.mVerificationExplain.setText(eu.siacs.conversations.app.R.string.smp_explain_question);
		...
		switch (smpStatus) {
			case Conversation.Smp.STATUS_WE_REQUESTED:
				...
				this.activateButton(this.mLeftButton, eu.siacs.conversations.app.R.string.cancel, this.mCancelSharedSecretListener);
				this.deactivateButton(this.mRightButton, eu.siacs.conversations.app.R.string.in_progress);
				break;
			case Conversation.Smp.STATUS_FAILED:
				...
				this.mSharedSecretSecret.setError(getString(eu.siacs.conversations.app.R.string.secrets_do_not_match));
				this.deactivateButton(this.mLeftButton, eu.siacs.conversations.app.R.string.cancel);
				this.activateButton(this.mRightButton, eu.siacs.conversations.app.R.string.try_again, this.mRetrySharedSecretListener);
				break;
			case Conversation.Smp.STATUS_VERIFIED:
				...
				this.deactivateButton(this.mLeftButton, eu.siacs.conversations.app.R.string.cancel);
				this.activateButton(this.mRightButton, eu.siacs.conversations.app.R.string.finish, this.mFinishListener);
				break;
			default:
				this.mStatusMessage.setVisibility(View.GONE);
				this.mSharedSecretHintEditable.setVisibility(View.VISIBLE);
				this.mSharedSecretSecret.setVisibility(View.VISIBLE);
				this.activateButton(this.mLeftButton, eu.siacs.conversations.app.R.string.cancel,this.mFinishListener);
				this.activateButton(this.mRightButton, eu.siacs.conversations.app.R.string.ask_question, this.mCreateSharedSecretListener);
				break;
		}
	}
	...
	protected void updateViewAnswerQuestion() {
		this.mManualVerificationArea.setVisibility(View.GONE);
		this.mSmpVerificationArea.setVisibility(View.VISIBLE);
		this.mVerificationExplain.setText(eu.siacs.conversations.app.R.string.smp_explain_answer);
		this.mSharedSecretHintEditable.setVisibility(View.GONE);
		...
		switch (smpStatus) {
			case Conversation.Smp.STATUS_CONTACT_REQUESTED:
				...
				this.activateButton(this.mRightButton, eu.siacs.conversations.app.R.string.respond,this.mRespondSharedSecretListener);
				break;
			case Conversation.Smp.STATUS_VERIFIED:
				this.mSharedSecretHintEditable.setText("");
				this.mSharedSecretHintEditable.setVisibility(View.GONE);
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(eu.siacs.conversations.app.R.layout.activity_verify_otr);
		this.mRemoteFingerprint = (TextView) findViewById(eu.siacs.conversations.app.R.id.remote_fingerprint);
		this.mYourFingerprint = (TextView) findViewById(eu.siacs.conversations.app.R.id.your_fingerprint);
		this.mLeftButton = (Button) findViewById(eu.siacs.conversations.app.R.id.left_button);
		this.mRightButton = (Button) findViewById(eu.siacs.conversations.app.R.id.right_button);
		this.mVerificationExplain = (TextView) findViewById(eu.siacs.conversations.app.R.id.verification_explanation);
		this.mStatusMessage = (TextView) findViewById(eu.siacs.conversations.app.R.id.status_message);
		this.mSharedSecretSecret = (EditText) findViewById(eu.siacs.conversations.app.R.id.shared_secret_secret);
		this.mSharedSecretHintEditable = (EditText) findViewById(eu.siacs.conversations.app.R.id.shared_secret_hint_editable);
		this.mSharedSecretHint = (TextView) findViewById(eu.siacs.conversations.app.R.id.shared_secret_hint);
		this.mManualVerificationArea = (LinearLayout) findViewById(eu.siacs.conversations.app.R.id.manual_verification_area);
		this.mSmpVerificationArea = (LinearLayout) findViewById(eu.siacs.conversations.app.R.id.smp_verification_area);
	}

	@Override
	public boolean onCreateOptionsMenu(final Menu menu) {
		super.onCreateOptionsMenu(menu);
		getMenuInflater().inflate(eu.siacs.conversations.app.R.menu.verify_otr, menu);
		return true;
	}

	private void showManuallyVerifyDialog() {
		AlertDialog.Builder builder = new AlertDialog.Builder(this);
		builder.setTitle(eu.siacs.conversations.app.R.string.manually_verify);
		builder.setMessage(eu.siacs.conversations.app.R.string.are_you_sure_verify_fingerprint);
		builder.setNegativeButton(eu.siacs.conversations.app.R.string.cancel, null);
		builder.setPositiveButton(eu.siacs.conversations.app.R.string.verify, mVerifyFingerprintListener);
		builder.create().show();
	}
