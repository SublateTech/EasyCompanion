...
import com.sublate.easycompanion.ui.adapter.ConversationAdapter;
import eu.siacs.conversations.xmpp.OnUpdateBlocklist;
import eu.siacs.conversations.xmpp.XmppConnection;
import eu.siacs.conversations.xmpp.jid.InvalidJidException;
import eu.siacs.conversations.xmpp.jid.Jid;
import eu.siacs.conversations.app.utils.ExceptionHelper;
...
public class ConversationActivity extends XmppActivity
	...
	protected void onCreate(final Bundle savedInstanceState) {
		...
		setContentView(eu.siacs.conversations.app.R.layout.fragment_conversations_overview);

		this.mConversationFragment = new ConversationFragment();
		FragmentTransaction transaction = getFragmentManager().beginTransaction();
		transaction.replace(eu.siacs.conversations.app.R.id.selected_conversation, this.mConversationFragment, "conversation");
		transaction.commit();

		listView = (EnhancedListView) findViewById(eu.siacs.conversations.app.R.id.list);
				...
				return new EnhancedListView.Undoable() {
					...
					public String getTitle() {
						if (swipedConversation.getMode() == Conversation.MODE_MULTI) {
							return getResources().getString(eu.siacs.conversations.app.R.string.title_undo_swipe_out_muc);
						} else {
							return getResources().getString(eu.siacs.conversations.app.R.string.title_undo_swipe_out_conversation);
						}
					}
				};
			}
		...
		listView.setSwipingLayout(eu.siacs.conversations.app.R.id.swipeable_item);
		listView.setUndoStyle(EnhancedListView.UndoStyle.SINGLE_POPUP);
		listView.setUndoHideDelay(5000);
		listView.setRequireTouchBeforeDismiss(false);

		mContentView = findViewById(eu.siacs.conversations.app.R.id.content_view_spl);
		if (mContentView == null) {
			mContentView = findViewById(eu.siacs.conversations.app.R.id.content_view_ll);
		}
		if (mContentView instanceof SlidingPaneLayout) {
			SlidingPaneLayout mSlidingPaneLayout = (SlidingPaneLayout) mContentView;
			mSlidingPaneLayout.setParallaxDistance(150);
			mSlidingPaneLayout
					.setShadowResource(eu.siacs.conversations.app.R.drawable.es_slidingpane_shadow);
	...
	public void onCreateContextMenu(ContextMenu menu, View v,
		...
		inflater.inflate(eu.siacs.conversations.app.R.menu.menu_user_options, menu);
		menu.setHeaderTitle("Location options");
	}
	@Override
	public boolean onContextItemSelected(MenuItem item) {
		...
		switch (item.getItemId()) {
			...
			case eu.siacs.conversations.app.R.id.user_profile_location:
				String fallbackPackageId = "eu.siacs.conversations.friendslocation";
				PackageManager pm = getApplicationContext().getPackageManager();
				boolean isInstalled = isPackageInstalled(fallbackPackageId, pm);
				if (isInstalled) {
					Conversation conversation = getSelectedConversation();

					final Contact contact = (Contact) conversation.getContact();
					contact.setAccount(conversation.getAccount());

					xmppConnectionService.getService().setContact(contact);
					Intent intent = new Intent(Intent.ACTION_VIEW);
					intent.setAction("eu.siacs.conversations.friendslocation.request");

					// intent.setData(Uri.parse("market://details?id=" + fallbackPackageId))
	...
	private void updateActionBarTitle(boolean titleShouldBeName) {
		...
		if (ab != null) {
			if (titleShouldBeName && conversation != null) {
				...
				ab.setTitle(eu.siacs.conversations.app.R.string.app_name);
			}
		}
	}
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		getMenuInflater().inflate(eu.siacs.conversations.app.R.menu.conversations, menu);
		final MenuItem menuSecure = menu.findItem(eu.siacs.conversations.app.R.id.action_security);
		final MenuItem menuArchive = menu.findItem(eu.siacs.conversations.app.R.id.action_archive);
		final MenuItem menuMucDetails = menu.findItem(eu.siacs.conversations.app.R.id.action_muc_details);
		final MenuItem menuContactDetails = menu.findItem(eu.siacs.conversations.app.R.id.action_contact_details);
		final MenuItem menuAttach = menu.findItem(eu.siacs.conversations.app.R.id.action_attach_file);
		final MenuItem menuClearHistory = menu.findItem(eu.siacs.conversations.app.R.id.action_clear_history);
		final MenuItem menuAdd = menu.findItem(eu.siacs.conversations.app.R.id.action_add);
		final MenuItem menuInviteContact = menu.findItem(eu.siacs.conversations.app.R.id.action_invite);
		final MenuItem menuMute = menu.findItem(eu.siacs.conversations.app.R.id.action_mute);
		final MenuItem menuUnmute = menu.findItem(eu.siacs.conversations.app.R.id.action_unmute);
			...
			if (this.getSelectedConversation() != null) {
				if (this.getSelectedConversation().getNextEncryption() != Message.ENCRYPTION_NONE) {
					if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
						menuSecure.setIcon(eu.siacs.conversations.app.R.drawable.ic_lock_white_24dp);
					} else {
						menuSecure.setIcon(eu.siacs.conversations.app.R.drawable.ic_action_secure);
					}
				}
		...
		if (Config.supportOmemo()) {
			new Handler().post(new Runnable() {
				@Override
				public void run() {
					View view = findViewById(eu.siacs.conversations.app.R.id.action_security);
					if (view != null) {
		...
		if (c != null) {
			...
			switch (capabilityJidPair.first) {
				case MISSING_PRESENCE:
					Toast.makeText(ConversationActivity.this,single ? getString(eu.siacs.conversations.app.R.string.missing_presence_subscription) : getString(eu.siacs.conversations.app.R.string.missing_presence_subscription_with_x,capabilityJidPair.second.toBareJid().toString()), Toast.LENGTH_SHORT).show();
					return true;
				case MISSING_KEYS:
					Toast.makeText(ConversationActivity.this,single ? getString(eu.siacs.conversations.app.R.string.missing_omemo_keys) : getString(eu.siacs.conversations.app.R.string.missing_keys_from_x,capabilityJidPair.second.toBareJid().toString()), Toast.LENGTH_SHORT).show();
					return true;
				case WRONG_CONFIGURATION:
					Toast.makeText(ConversationActivity.this, eu.siacs.conversations.app.R.string.wrong_conference_configuration, Toast.LENGTH_SHORT).show();
					return true;
				case NO_MEMBERS:
					Toast.makeText(ConversationActivity.this, eu.siacs.conversations.app.R.string.this_conference_has_no_members, Toast.LENGTH_SHORT).show();
					return true;
			}
		}
		return false;
			...
			public void onPresenceSelected() {
				...
				switch (attachmentChoice) {
					...
					case ATTACHMENT_CHOICE_LOCATION:
						...
						fallbackPackageId = "eu.siacs.conversations.location";
						break;
				}
				if (intent.resolveActivity(getPackageManager()) != null) {
					if (chooser) {
						startActivityForResult(
								Intent.createChooser(intent, getString(eu.siacs.conversations.app.R.string.perform_action_with)),
								attachmentChoice);
					} else {
	...
	public void onRequestPermissionsResult(int requestCode, String permissions[], int[] grantResults) {
		if (grantResults.length > 0)
			if (grantResults[0] == PackageManager.PERMISSION_GRANTED) {
				...
				Toast.makeText(this, eu.siacs.conversations.app.R.string.no_storage_permission, Toast.LENGTH_SHORT).show();
			}
	}
	...
	public void startDownloadable(Message message) {
		...
		if (transferable != null) {
			if (!transferable.start()) {
				Toast.makeText(this, eu.siacs.conversations.app.R.string.not_connected_try_again, Toast.LENGTH_SHORT).show();
			}
	...
	public boolean onOptionsItemSelected(final MenuItem item) {
		if (item.getItemId() == android.R.id.home) {
			...
			return true;
		} else if (item.getItemId() == eu.siacs.conversations.app.R.id.action_add) {
			startActivity(new Intent(this, StartConversationActivity.class));
			return true;
		} else if (getSelectedConversation() != null) {
			switch (item.getItemId()) {
				case eu.siacs.conversations.app.R.id.action_attach_file:
					attachFileDialog();
					break;
				case eu.siacs.conversations.app.R.id.action_archive:
				...
				case eu.siacs.conversations.app.R.id.action_contact_details:
					...
					break;
				case eu.siacs.conversations.app.R.id.action_muc_details:
					...
					startActivity(intent);
					break;
				case eu.siacs.conversations.app.R.id.action_invite:
					inviteToConversation(getSelectedConversation());
					break;
				case eu.siacs.conversations.app.R.id.action_security:
					selectEncryptionDialog(getSelectedConversation());
					break;
				case eu.siacs.conversations.app.R.id.action_clear_history:
					clearHistoryDialog(getSelectedConversation());
					break;
				case eu.siacs.conversations.app.R.id.action_mute:
					muteConversationDialog(getSelectedConversation());
					break;
				case eu.siacs.conversations.app.R.id.action_unmute:
					unmuteConversation(getSelectedConversation());
					break;
				case eu.siacs.conversations.app.R.id.action_block:
					BlockContactDialog.show(this, xmppConnectionService, getSelectedConversation());
					break;
				case eu.siacs.conversations.app.R.id.action_unblock:
					BlockContactDialog.show(this, xmppConnectionService, getSelectedConversation());
					break;
				default:
					break;
	...
	protected void clearHistoryDialog(final Conversation conversation) {
		...
		builder.setTitle(getString(eu.siacs.conversations.app.R.string.clear_conversation_history));
		View dialogView = getLayoutInflater().inflate(
				eu.siacs.conversations.app.R.layout.dialog_clear_history, null);
		final CheckBox endConversationCheckBox = (CheckBox) dialogView
				.findViewById(eu.siacs.conversations.app.R.id.end_conversation_checkbox);
		builder.setView(dialogView);
		builder.setNegativeButton(getString(eu.siacs.conversations.app.R.string.cancel), null);
		builder.setPositiveButton(getString(eu.siacs.conversations.app.R.string.delete_messages),
				new OnClickListener() {
	...
	protected void attachFileDialog() {
		View menuAttachFile = findViewById(eu.siacs.conversations.app.R.id.action_attach_file);
		if (menuAttachFile == null) {
			return;
		}
		PopupMenu attachFilePopup = new PopupMenu(this, menuAttachFile);
		attachFilePopup.inflate(eu.siacs.conversations.app.R.menu.attachment_choices);
		if (new Intent(MediaStore.Audio.Media.RECORD_SOUND_ACTION).resolveActivity(getPackageManager()) == null) {
			attachFilePopup.getMenu().findItem(eu.siacs.conversations.app.R.id.attach_record_voice).setVisible(false);
		}
		if (new Intent("eu.siacs.conversations.location.request").resolveActivity(getPackageManager()) == null) {
			attachFilePopup.getMenu().findItem(eu.siacs.conversations.app.R.id.attach_location).setVisible(false);
		}
		attachFilePopup.setOnMenuItemClickListener(new OnMenuItemClickListener() {
			...
			public boolean onMenuItemClick(MenuItem item) {
				switch (item.getItemId()) {
					case eu.siacs.conversations.app.R.id.attach_choose_picture:
						attachFile(ATTACHMENT_CHOICE_CHOOSE_IMAGE);
						break;
					case eu.siacs.conversations.app.R.id.attach_take_picture:
						attachFile(ATTACHMENT_CHOICE_TAKE_PHOTO);
						break;
					case eu.siacs.conversations.app.R.id.attach_choose_file:
						attachFile(ATTACHMENT_CHOICE_CHOOSE_FILE);
						break;
					case eu.siacs.conversations.app.R.id.attach_record_voice:
						attachFile(ATTACHMENT_CHOICE_RECORD_VOICE);
						break;
					case eu.siacs.conversations.app.R.id.attach_location:
	...
	public void verifyOtrSessionDialog(final Conversation conversation, View view) {
		if (!conversation.hasValidOtrSession() || conversation.getOtrSession().getSessionStatus() != SessionStatus.ENCRYPTED) {
			Toast.makeText(this, eu.siacs.conversations.app.R.string.otr_session_not_started, Toast.LENGTH_LONG).show();
			return;
		}
		if (view == null) {
			return;
		...
		popup.inflate(eu.siacs.conversations.app.R.menu.verification_choices);
		popup.setOnMenuItemClickListener(new OnMenuItemClickListener() {
			...
			public boolean onMenuItemClick(MenuItem menuItem) {
				...
				switch (menuItem.getItemId()) {
					case eu.siacs.conversations.app.R.id.scan_fingerprint:
						intent.putExtra("mode", VerifyOTRActivity.MODE_SCAN_FINGERPRINT);
						break;
					case eu.siacs.conversations.app.R.id.ask_question:
						intent.putExtra("mode", VerifyOTRActivity.MODE_ASK_QUESTION);
						break;
					case eu.siacs.conversations.app.R.id.manual_verification:
	...
	protected void selectEncryptionDialog(final Conversation conversation) {
		View menuItemView = findViewById(eu.siacs.conversations.app.R.id.action_security);
		...
		if (fragment != null) {
			popup.setOnMenuItemClickListener(new OnMenuItemClickListener() {
				...
				public boolean onMenuItemClick(MenuItem item) {
					switch (item.getItemId()) {
						case eu.siacs.conversations.app.R.id.encryption_choice_none:
							conversation.setNextEncryption(Message.ENCRYPTION_NONE);
							item.setChecked(true);
							break;
						case eu.siacs.conversations.app.R.id.encryption_choice_otr:
							conversation.setNextEncryption(Message.ENCRYPTION_OTR);
							item.setChecked(true);
							break;
						case eu.siacs.conversations.app.R.id.encryption_choice_pgp:
							if (hasPgp()) {
							...
							break;
						case eu.siacs.conversations.app.R.id.encryption_choice_axolotl:
			...
			popup.inflate(eu.siacs.conversations.app.R.menu.encryption_choices);
			MenuItem otr = popup.getMenu().findItem(eu.siacs.conversations.app.R.id.encryption_choice_otr);
			MenuItem none = popup.getMenu().findItem(eu.siacs.conversations.app.R.id.encryption_choice_none);
			MenuItem pgp = popup.getMenu().findItem(eu.siacs.conversations.app.R.id.encryption_choice_pgp);
			MenuItem axolotl = popup.getMenu().findItem(eu.siacs.conversations.app.R.id.encryption_choice_axolotl);
	...
	protected void muteConversationDialog(final Conversation conversation) {
		AlertDialog.Builder builder = new AlertDialog.Builder(this);
		builder.setTitle(eu.siacs.conversations.app.R.string.disable_notifications);
		final int[] durations = getResources().getIntArray(eu.siacs.conversations.app.R.array.mute_options_durations);
		builder.setItems(eu.siacs.conversations.app.R.array.mute_options_descriptions,
				new OnClickListener() {
	...
	void onBackendConnected() {
		...
		if (mPendingConferenceInvite != null) {
			if (mPendingConferenceInvite.execute(this)) {
				mToast = Toast.makeText(this, eu.siacs.conversations.app.R.string.creating_conference, Toast.LENGTH_LONG);
				mToast.show();
			}
	...
	private void openBatteryOptimizationDialogIfNeeded() {
		if (hasAccountWithoutPush()
			...
			AlertDialog.Builder builder = new AlertDialog.Builder(this);
			builder.setTitle(eu.siacs.conversations.app.R.string.battery_optimizations_enabled);
			builder.setMessage(eu.siacs.conversations.app.R.string.battery_optimizations_enabled_dialog);
			builder.setPositiveButton(eu.siacs.conversations.app.R.string.next, new OnClickListener() {
				@Override
				public void onClick(DialogInterface dialog, int which) {
					...
					try {
						...
						Toast.makeText(ConversationActivity.this, eu.siacs.conversations.app.R.string.device_does_not_support_battery_op, Toast.LENGTH_SHORT).show();
					}
				}
			});
			if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR2) {
	...
	private void attachFileToConversation(Conversation conversation, Uri uri) {
		...
		final Toast prepareFileToast = Toast.makeText(getApplicationContext(),getText(eu.siacs.conversations.app.R.string.preparing_file), Toast.LENGTH_LONG);
	...
	private void attachImageToConversation(Conversation conversation, Uri uri) {
		...
		final Toast prepareFileToast = Toast.makeText(getApplicationContext(),getText(eu.siacs.conversations.app.R.string.preparing_image), Toast.LENGTH_LONG);
		prepareFileToast.show();
