package com.sublate.easycompanion.ui.forms;
...
public class FormBooleanFieldWrapper extends FormFieldWrapper {
	...
	protected FormBooleanFieldWrapper(Context context, Field field) {
		super(context, field);
		checkBox = (CheckBox) view.findViewById(eu.siacs.conversations.app.R.id.field);
	...
	protected void setLabel(String label, boolean required) {
		CheckBox checkBox = (CheckBox) view.findViewById(eu.siacs.conversations.app.R.id.field);
	...
	public boolean validates() {
		if (checkBox.isChecked() || !field.isRequired()) {
			...
			checkBox.setError(context.getString(eu.siacs.conversations.app.R.string.this_field_is_required));
	...
	protected int getLayoutResource() {
		return eu.siacs.conversations.app.R.layout.form_boolean;
	}
