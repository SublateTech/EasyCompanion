...
public class FormTextFieldWrapper extends FormFieldWrapper {
	...
	protected FormTextFieldWrapper(Context context, Field field) {
		super(context, field);
		editText = (EditText) view.findViewById(eu.siacs.conversations.app.R.id.field);
	...
	protected void setLabel(String label, boolean required) {
		TextView textView = (TextView) view.findViewById(eu.siacs.conversations.app.R.id.label);
	...
	public boolean validates() {
		if (getValue().trim().length() > 0 || !field.isRequired()) {
			...
			editText.setError(context.getString(eu.siacs.conversations.app.R.string.this_field_is_required));
	...
	protected int getLayoutResource() {
		return eu.siacs.conversations.app.R.layout.form_text;
	}
