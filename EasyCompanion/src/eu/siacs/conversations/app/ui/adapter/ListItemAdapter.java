...
public class ListItemAdapter extends ArrayAdapter<ListItem> {
	...
	public View getView(int position, View view, ViewGroup parent) {
		...
		if (view == null) {
			view = inflater.inflate(eu.siacs.conversations.app.R.layout.contact, parent, false);
		}
		TextView tvName = (TextView) view.findViewById(eu.siacs.conversations.app.R.id.contact_display_name);
		TextView tvJid = (TextView) view.findViewById(eu.siacs.conversations.app.R.id.contact_jid);
		ImageView picture = (ImageView) view.findViewById(eu.siacs.conversations.app.R.id.contact_photo);
		FlowLayout tagLayout = (FlowLayout) view.findViewById(eu.siacs.conversations.app.R.id.tags);
		...
		if (tags.size() == 0 || !this.showDynamicTags) {
			...
			for(ListItem.Tag tag : tags) {
				TextView tv = (TextView) inflater.inflate(eu.siacs.conversations.app.R.layout.list_item_tag,tagLayout,false);
