...
public abstract class XmppActivity extends Activity {
	...
	protected Runnable onOpenPGPKeyPublished = new Runnable() {
		@Override
		public void run() {
			Toast.makeText(XmppActivity.this, eu.siacs.conversations.R.string.openpgp_has_been_published, Toast.LENGTH_SHORT).show();
		}
	};
	...
	public void showInstallPgpDialog() {
		...
		builder.setNeutralButton(getString(eu.siacs.conversations.R.string.restart),
				new OnClickListener() {
		...
		builder.setPositiveButton(getString(eu.siacs.conversations.R.string.install),
				new OnClickListener() {
	...
	public boolean onOptionsItemSelected(final MenuItem item) {
		switch (item.getItemId()) {
			case eu.siacs.conversations.app.R.id.action_settings:
				startActivity(new Intent(this, SettingsActivity.class));
				break;
			case eu.siacs.conversations.app.R.id.action_accounts:
				startActivity(new Intent(this, ManageAccountActivity.class));
				break;
			case android.R.id.home:
				finish();
				break;
			case eu.siacs.conversations.app.R.id.action_show_qr_code:
				showQrCode();
				break;
		}
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mPrimaryTextColor = getResources().getColor(eu.siacs.conversations.R.color.black87);
		mSecondaryTextColor = getResources().getColor(eu.siacs.conversations.R.color.black54);
		mTertiaryTextColor = getResources().getColor(eu.siacs.conversations.R.color.black12);
		mColorRed = getResources().getColor(eu.siacs.conversations.R.color.red800);
		mColorOrange = getResources().getColor(eu.siacs.conversations.R.color.orange500);
		mColorGreen = getResources().getColor(eu.siacs.conversations.R.color.green500);
		mPrimaryColor = getResources().getColor(eu.siacs.conversations.R.color.primary500);
		mPrimaryBackgroundColor = getResources().getColor(eu.siacs.conversations.R.color.grey50);
		mSecondaryBackgroundColor = getResources().getColor(eu.siacs.conversations.R.color.grey200);

		if(isDarkTheme()) {
			mPrimaryTextColor = getResources().getColor(eu.siacs.conversations.R.color.white);
			mSecondaryTextColor = getResources().getColor(eu.siacs.conversations.R.color.white70);
			mTertiaryTextColor = getResources().getColor(eu.siacs.conversations.R.color.white12);
			mPrimaryBackgroundColor = getResources().getColor(eu.siacs.conversations.R.color.grey800);
			mSecondaryBackgroundColor = getResources().getColor(eu.siacs.conversations.R.color.grey900);
		}
	...
	protected void setListItemBackgroundOnView(View view) {
		...
		if (sdk < android.os.Build.VERSION_CODES.JELLY_BEAN) {
			view.setBackgroundDrawable(getResources().getDrawable(eu.siacs.conversations.app.R.drawable.greybackground));
		} else {
			view.setBackground(getResources().getDrawable(eu.siacs.conversations.app.R.drawable.greybackground));
		}
	}
	...
	private void quickEdit(final String previousValue,
						   ...
						   boolean password) {
		AlertDialog.Builder builder = new AlertDialog.Builder(this);
		View view = getLayoutInflater().inflate(eu.siacs.conversations.app.R.layout.quickedit, null);
		final EditText editor = (EditText) view.findViewById(eu.siacs.conversations.app.R.id.editor);
	...
	private void showPresenceSelectionDialog(Presences presences, final Conversation conversation, final OnPresenceSelected listener) {
		...
		builder.setNegativeButton(eu.siacs.conversations.R.string.cancel, null);
		builder.setPositiveButton(eu.siacs.conversations.R.string.ok, new OnClickListener() {
	...
	protected void shareUri() {
		...
		try {
			startActivity(Intent.createChooser(shareIntent, getText(eu.siacs.conversations.R.string.share_uri_with)));
		} catch (ActivityNotFoundException e) {
			Toast.makeText(this, eu.siacs.conversations.R.string.no_application_to_share_uri, Toast.LENGTH_SHORT).show();
		}
	}
	...
	protected int findTheme() {
		...
		if(dark) {
			if(larger)
				return eu.siacs.conversations.app.R.style.ConversationsTheme_Dark_LargerText;
			else
				return eu.siacs.conversations.app.R.style.ConversationsTheme_Dark;
		} else {
			if (larger)
				return eu.siacs.conversations.app.R.style.ConversationsTheme_LargerText;
			else
				return eu.siacs.conversations.app.R.style.ConversationsTheme;
		}
	}
