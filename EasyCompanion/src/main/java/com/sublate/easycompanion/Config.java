package com.sublate.easycompanion;
...
public final class Config {
	...
	public static final String EXTRA_COMMAND = "eu.siacs.conversations" + ".COMMAND";
	...
	public static final String LOGTAG = "easecompanion";

	public static final String BUG_REPORTS = "bugs@sublate.com";
