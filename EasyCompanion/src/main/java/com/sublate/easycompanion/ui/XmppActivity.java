...
import com.sublate.easycompanion.provider.BarcodeProvider;
...
public abstract class XmppActivity extends Activity {
	...
	protected int findTheme() {
		...
		if(dark) {
			if(larger)
				return com.sublate.easycompanion.R.style.ConversationsTheme_Dark_LargerText;
			else
				return com.sublate.easycompanion.R.style.ConversationsTheme_Dark;
		} else {
			if (larger)
				return com.sublate.easycompanion.R.style.ConversationsTheme_LargerText;
			else
				return com.sublate.easycompanion.R.style.ConversationsTheme;
		}
	}
