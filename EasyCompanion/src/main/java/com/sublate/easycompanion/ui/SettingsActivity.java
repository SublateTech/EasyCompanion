...
public class SettingsActivity extends XmppActivity implements
	...
	public void onStart() {
		...
		removeCertsPreference.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
			...
			public boolean onPreferenceClick(Preference preference) {
				...
				if (aliases.size() == 0) {
					displayToast(getString(eu.siacs.conversations.R.string.toast_no_trusted_certs));
					return true;
				}
				final ArrayList selectedItems = new ArrayList<>();
				final AlertDialog.Builder dialogBuilder = new AlertDialog.Builder(SettingsActivity.this);
				dialogBuilder.setTitle(getResources().getString(eu.siacs.conversations.R.string.dialog_manage_certs_title));
				...
				dialogBuilder.setPositiveButton(
						getResources().getString(eu.siacs.conversations.R.string.dialog_manage_certs_positivebutton), new DialogInterface.OnClickListener() {
							@Override
							public void onClick(DialogInterface dialog, int which) {
								...
								if (count > 0) {
									...
									displayToast(getResources().getQuantityString(eu.siacs.conversations.R.plurals.toast_delete_certificates, count, count));
								}
							}
						});
				dialogBuilder.setNegativeButton(getResources().getString(eu.siacs.conversations.R.string.dialog_manage_certs_negativebutton), null);
	...
	private void deleteOmemoIdentities() {
		...
		builder.setTitle(eu.siacs.conversations.R.string.pref_delete_omemo_identities);
		...
		builder.setPositiveButton(eu.siacs.conversations.R.string.delete_selected_keys, new DialogInterface.OnClickListener() {
			@Override
			public void onClick(DialogInterface dialog, int which) {
		...
		if (name.equals("resource")) {
			...
			if (xmppConnectionServiceBound) {
				...
				if (name.equals(MANUALLY_CHANGE_PRESENCE) && !noAccountUsesPgp()) {
					Toast.makeText(this, eu.siacs.conversations.R.string.republish_pgp_keys, Toast.LENGTH_LONG).show();
				}
	...
	public void onRequestPermissionsResult(int requestCode, String[] permissions, int[] grantResults) {
		if (grantResults.length > 0)
			if (grantResults[0] == PackageManager.PERMISSION_GRANTED) {
				...
				Toast.makeText(this, eu.siacs.conversations.R.string.no_storage_permission, Toast.LENGTH_SHORT).show();
			}
	}
