...
public class LocationExtended {
    ...
    public String getFormattedLatitude() {
        boolean prefShowDecimalCoordinates = Preferences.Export.getPrefShowDecimalCoordinates();
        if (_Location != null) {
    ...
    public String getFormattedAltitude() {
        if (_Location != null) {
            TrackerApp TrackerApp = TrackerApp.getInstance();
            int UM = TrackerApp.getPrefUM();
            switch (UM) {
    ...
    */
    ...
    public String getFormattedSpeed() {
        if (_Location != null) {
            int UM = Preferences.Export.getPrefUM();
            switch (UM) {
    ...
    public String getFormattedBearing() {
        if (_Location != null) {
            int pDir = Preferences.Export.getPrefShowDirections();
            if (_Location.hasBearing()) {

                switch (pDir) {
                    case 0:         // NSWE
                        final String N = "N"; //TrackerApp.getInstance().getString(R.string.north);
                        final String S = "S" ; //TrackerApp.getInstance().getString(R.string.south);
                        final String W = "W"; //TrackerApp.getInstance().getString(R.string.west);
                        final String E = "E"; //TrackerApp.getInstance().getString(R.string.east);
    ...
    public String getFormattedLatitudeUM() {
        //TrackerApp TrackerApp1 = TrackerApp.getInstance();
        final String N = "N"; //TrackerApp1.getString(R.string.north);
        final String S = "S"; //TrackerApp1.getString(R.string.south);
    ...
    public String getFormattedLongitudeUM() {
        //TrackerApp TrackerApp1 = TrackerApp.getInstance();
        final String E = "E"; //TrackerApp1.getString(R.string.east);
        final String W = "W"; //TrackerApp1.getString(R.string.west);
